...
devils_schedule = pd.read_csv(os.path.join(INPUT_DIR, "avalanche_schedule_2425.txt"))
...
formatted_schedule.to_csv(os.path.join(INPUT_DIR, "avalanche_schedule_2425_formatted.csv"), index=False)
